 ...
 * @author trang
 */
@WebServlet(name="Infomentee", urlPatterns={"/infomentee"})
public class Infomentee extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Infomentee</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Infomentee at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
        ...
        if (id != null && !id.isEmpty()) {
            try {
                ...
                if (id!= null) {
                    ...
                    request.getRequestDispatcher("Infomentee.jsp").forward(request, response);
