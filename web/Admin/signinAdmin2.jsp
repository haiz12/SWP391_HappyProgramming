<%-- 
    Document   : signinAdmin2
    Created on : Mar 9, 2024, 2:45:22 PM
    Author     : ADMIN
--%>
        ...
        <div class="container">
            <div class="screen">
                <div class="screen__content">
                    <h2 style="color: #0c63e4;margin-top: 40px;margin-left: 10px">Only for Admin 2</h2>
                    <h1 style="color: red">${mess}</h1>
                    <form class="login" action="signinadmin2" method="post">
